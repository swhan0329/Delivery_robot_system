...
class Detection:
    ...
    def find_address(self, image, mask):
        ...
        if contour:
            for cnt in contour:
                ...
                if area > 900 and area < 1200 and epsilon < 5 and epsilon > 3:
    ...
    def detect_flag(self, image, green_stop_frame=self.green_stop_frame):
        ...
        if self.enforce_mode:
            ...
            if len(self.Green_queue) > green_stop_frame: #14
